...
function informacion(tech){
    ...
    buttonInteresado.setAttribute('href','https://api.whatsapp.com/send?phone='+'56992710472'+'&text='+'Buen%20día%20quisiera%20informes%20de%20programa%20'+tech.id+'%20'+removeSpacesFromString(tech.programa)+'%20en%20'+removeSpacesFromString(tech.pais)+'📚')
    buttonInteresado.textContent=('Me interesa')
    buttonCards.appendChild(buttonInteresado)
